...
{
    public const string TypeName = "VirtoCommerce.ElasticSearch9.Tests.PriorityTestCaseOrderer";
    public const string AssemblyName = "VirtoCommerce.ElasticSearch9.Tests";
