...
public partial class ElasticSearch9Provider : ISearchProvider, ISupportIndexSwap, ISupportIndexCreate
{
    ...
    protected virtual async Task CreateMLPipeline(string pipelineName)
    {
